...
const FreeformHandler = require("./handler/FreeformHandler");
...
class DiscordBot extends Client {
    ...
    login_timestamp = 0;
    statusMessages = [
        { name: 'Helping you stay on task :)', type: 4 },
        { name: 'What to do right now?', type: 4 },
        { name: 'Productivity', type: 3 }
    ];

    commands_handler = new CommandsHandler(this);
    components_handler = new ComponentsHandler(this);
    events_handler = new EventsHandler(this);
    freeform_handler = new FreeformHandler(this);
